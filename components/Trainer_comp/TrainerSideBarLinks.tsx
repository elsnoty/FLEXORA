import { User, Dumbbell, MessageSquare, BarChart, Users, CreditCard, Calendar } from "lucide-react";
...
export async function GetTrainerSideLinks() {
    ...
    return [
        ...
        { href: "/trainer/schedule", label: "Schedule", icon: <Calendar className="h-5 w-5" /> },
